...
interface PressTheButtonTwoGameProps {
  gameId: string;
  isAdmin: boolean;
}

export function PressTheButtonTwoGame({ gameId, isAdmin }: PressTheButtonTwoGameProps) {
  ...
  if (loading) {
    return (
      <div className="text-center py-8">
        <div className="text-slate-400 animate-pulse">Initialising surveillance systems...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-slate-800/95 rounded-xl p-5 sm:p-6 text-center">
        ...
        <h3 className="text-amber-400 font-bold text-lg mb-2">The Control Room Returns</h3>
        <p className="text-slate-400 text-sm max-w-md mx-auto mb-6 leading-relaxed">
          The shift is harder. The anomalies are stranger. Survive all stages — watch the monitors, read the signals, press wisely.
        </p>

        <a
          href="/games/press-the-button-two"
          target="_blank"
